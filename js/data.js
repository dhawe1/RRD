...
const images = {
  ...
  sections: {
    ...
    hydrocarbon: "assets/images/sections/crude.png",
    crude: "assets/images/sections/hydrocarbon.png",
  ...
  /* Centralized placeholders for the five Laboratory Storage cards —
     set any path below to the real photo later; nothing else needs to
     change. */
  storage: {
  ...
  /* Centralized placeholders for the three Laboratory Safety cards' large
     images — set any path below to the real photo later; nothing else
     needs to change. */
  safety: {
  ...
  equipment: {
    ...
    ChorideOfen: "assets/images/equipment/chim/ChorideOfen.JPG",
    HPLC_DE: "assets/images/equipment/chim/HPLC_DE.JPG",
    HPLC_JET: "assets/images/equipment/Chim/HPLC_JET.JPG",
    HPNA: "assets/images/equipment/chim/HPNA.JPG",
    KarlF: "assets/images/equipment/chim/KarlF.JPG",
    LECO: "assets/images/equipment/chim/LECO.JPG",
    Mercapin: "assets/images/equipment/chim/Mercapin.JPG",
    N2: "assets/images/equipment/chim/N2.JPG",
    Ofen: "assets/images/equipment/chim/Ofen.JPG",
